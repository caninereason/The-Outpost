...
with a different chemical compound.To the EAST looks like a long corridor, and
a circular room is visable to the SOUTH\n """
,[0,12,0,8,0,0,0],"")
...
,[8,12,0,0,5,0,0],"")
r8=room(8,"""A large dome shaped room, full of floating globes of glowing jelly. They
...
,[4,2,13,0,0,0,0],"")
r5 =room(5, """The room seems empty except for an oddly shaped piece of machinery resting
...
,[7,1,6,0,0,0,0] ,"")
r3 =room(3,"""You have entered a large room where a pair of doors face each other across a
...
with many doors""")
                ...
                if location==12 and inv[0] != True:
                    ...
                    loop()
                     ...
                     dprint("""as you approach the door the object in your pocket begins to pulse and
...
revealing a huge central control station. You enter cautiously...""")
                ...
                if location ==13 and lazer :
                    dprint("""As you approach the door you hear a sharp metalic sound and what looks like
...
stasis gases. ' We shall find home soon captain, sleep well""")
                 ...
                 dprint('.')
                 time.sleep(tdelay)
                 dprint("""congratulations on completing the outpost, many adventurers have fallen
here, and we commend you for your wit,skill and expertise, see you in the next
adventure."""
)
            elif location ==14 and goal != "nothing":
                 dprint("""'that is incorrect, I am sorry captain you have not worthy.'The room starts
