...
r12=room(12,"""You find yourself in a long corridor with 2 doors leading off to the EAST and a hatch leading SOUTH. The corridor ends in an open doorway leading NORTH. Would you like to take the FIRST or SECOND door to the east, or head NORTH or SOUTH""",[11,0,13,0,9,10,0],"You examine the contents of the crate. Inside you find a small stack of papers. They are written in what appears to be an ancient script, which you do not recognize.")
...
On one shelf stands a metal box, seemingly empty. There is a small hatch in the bottom of the box. You open the box and find that it contains a large collection of vials, each labeled with a different chemical compound.To the EAST looks like a long corridor, and a circular room is visable to the SOUTH """,[0,12,0,8,0,0,0],"")
r10=room(10,"""Here you discover a room containing rows of shelves crammed with crates, barrels, boxes and other containers. It smells damp and musty here. In the middle of the room is a large metal cylinder with a door set into its side labeled Z. There is also a passage leading EAST to the upper level. """,[5,0,0,0,12,0,0],"")
r9=room(9,""" you enter a small room with an old wooden desk. On top of the desk sits a book that looks like it might contain useful information. """,[8,0,0,0,5,12,0],"")
...
The machine has been broken into pieces. A few gears and wheels remain intact, along with a couple of wires that run down its spine. All the other parts lie scattered across the floor. Exits lie NORTH, EAST and WEST """,[3,10,9,0,0,0,0],"")
